...
TEST_F(TestSimpleIdMapper, Init) {
  ...
  EXPECT_EQ(id_mapper.GetWorkerHelperThreadsForId(1)[0],
            SimpleIdMapper::kMaxThreadsPerNode + SimpleIdMapper::kWorkerHelperThreadId);
  ...
  EXPECT_EQ(id_mapper.GetWorkerHelperThreadsForId(3)[0],
            3 * SimpleIdMapper::kMaxThreadsPerNode + SimpleIdMapper::kWorkerHelperThreadId);
...
TEST_F(TestSimpleIdMapper, AllocateDeallocateThread) {
  ...
  EXPECT_EQ(id_mapper.GetWorkerThreadsForId(1)[0],
            SimpleIdMapper::kMaxThreadsPerNode + SimpleIdMapper::kMaxBgThreadsPerNode);
  EXPECT_EQ(id_mapper.GetWorkerThreadsForId(1)[1],
            SimpleIdMapper::kMaxThreadsPerNode + SimpleIdMapper::kMaxBgThreadsPerNode + 1);
